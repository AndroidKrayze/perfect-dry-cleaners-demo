    ...
    <section id="reviews" className="bg-blush/30 px-4 py-16 sm:px-6 sm:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-3 max-w-xl text-sm text-charcoal/60">
          A small public sample — specific praise over star walls. Sources
          labelled.
        </p>
        ...
        <ul className="mt-10 grid gap-4 md:grid-cols-2">
          {siteConfig.reviews.map((r) => (
            <li
              ...
              className="rounded-2xl border border-blush/90 bg-pearl p-6 shadow-soft"
            >
              <div className="flex gap-1 text-gold" aria-label="Positive review">
